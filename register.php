        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-6 col-md-3">
                <form class="form-container" action="includes/register.inc.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="exampleInputDigits">12 Digits Code</label>
                        <input type="text" class="form-control" id="exampleInputDigits" aria-describedby="emailHelp" placeholder="Enter 12 Digits Code" name="code">
                    </div>
                    <div class="form-group">
