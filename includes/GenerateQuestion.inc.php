...
if(isset($_POST['add_exam']))
{
    ...
    $query = "SELECT * FROM questionmaster WHERE classid = ? AND subjectid = ? AND chapterid = ? AND questiontype = ? AND language = ? ORDER BY rand() LIMIT ?;";
    ...
    {
        mysqli_stmt_bind_param($stmt,"ssssss",$classid,$subjectid,$chapterid,$ques_type,$ques_lang,$numberQues);
